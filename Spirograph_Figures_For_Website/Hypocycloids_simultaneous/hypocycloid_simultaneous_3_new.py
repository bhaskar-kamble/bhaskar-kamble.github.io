...
lobj = ax.plot([],[],lw=1,color="black",linestyle="")[0]  #complete hypocycloid
lines.append(lobj)


lobj = ax.plot([],[],lw=1,color="black")[0]  #fixed circle
lines.append(lobj)
lobj = ax.plot([],[],lw=1,color="black")[0]   #hypocycloid 1
lines.append(lobj)
...
lobj = ax.plot([],[],linestyle="none",marker="o",markersize=5,color="blue")[0] #point on circle with radius r1
lines.append(lobj)
lobj = ax.plot([],[],lw=2,color="blue")[0] #line joining fixed points on circle 1
lines.append(lobj)
lobj = ax.plot([],[],lw=2,color="blue")[0] #line joining fixed points on circle 1
lines.append(lobj)
lobj = ax.plot([],[],lw=2,color="blue")[0] #line joining fixed points on circle 1
lines.append(lobj)
lobj = ax.plot([],[],lw=2,color="blue")[0] #circle with radius r1 
lines.append(lobj)



lobj = ax.plot([],[],lw=1,color="black")[0] #hypocycloid 2
lines.append(lobj)
...
lobj = ax.plot([],[],linestyle="none",marker="o",markersize=5,color="red")[0] # point on the 2nd circle
lines.append(lobj)
lobj = ax.plot([],[],lw=2,color="red")[0] #line joining fixed points on circle 2
lines.append(lobj)
lobj = ax.plot([],[],lw=2,color="red")[0] #line joining fixed points on circle 2
lines.append(lobj)
lobj = ax.plot([],[],lw=2,color="red")[0] #line joining fixed points on circle 2
...
lobj = ax.plot([],[],lw=2,color="red")[0]  # circle with radius r2
lines.append(lobj)
...
anim.save('hypo_r_15by37_22by37.mp4', fps=50, extra_args=['-vcodec', 'libx264'])
