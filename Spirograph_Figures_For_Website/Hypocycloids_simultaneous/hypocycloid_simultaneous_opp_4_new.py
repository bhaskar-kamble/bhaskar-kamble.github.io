...
#one circle goes in opposite sense
import numpy as np
...
m_rad2=3.0
nR = 5.0
r1 = m_rad1/nR   #2/5 and 3/5 give the same picture! 1/5 and 4/5 give the same picture!
r2 = m_rad2/nR
R = 1.0
...
anim.save("hypo_r_2by5_3by5_R_opp.gif",dpi=80,writer='imagemagick')#, fps=30)
